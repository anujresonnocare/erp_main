...
class HelpdeskDashboardController(http.Controller):
    ...
    @http.route('/helpdesk/dashboard/kpis', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/helpdesk/team/dashboard/kpis', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/helpdesk/dashboard/teams', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/helpdesk/dashboard/ticket-trend', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/helpdesk/dashboard/state-distribution', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/helpdesk/dashboard/priority-distribution', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/helpdesk/dashboard/sla-status', type='json', auth='user', methods=['POST'], csrf=False)
