...
class ResPartner(models.Model):
    ...
    msme_registered = fields.Boolean(
        string="MSME Registered"
    )
    ...
    tds_section = fields.Char(
        string="TDS Section"
    )

    tds_exemption = fields.Boolean(
        string="TDS Exemption Certificate Available"
    )
    ...
    contact_person_designation = fields.Char(
        string="Contact Person Designation"
    )

    contact_person_mobile = fields.Char(
        string="Contact Person Mobile"
    )
